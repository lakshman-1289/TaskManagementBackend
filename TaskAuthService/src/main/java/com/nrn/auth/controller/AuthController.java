package com.nrn.auth.controller;
...
import com.nrn.auth.config.JwtProvider;
import com.nrn.auth.model.AuthResponse;
import com.nrn.auth.model.LoginRequest;
import com.nrn.auth.model.User;
import com.nrn.auth.repository.UserRepository;
import com.nrn.auth.service.CustomUserDetailsServiceImplementation;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> createUserHandler(@RequestBody User user) throws Exception {
        ...
        String jwt = JwtProvider.generateToken(authentication, savedUser);
        logger.info("JWT generated for registered user: {} with ID: {}", email, savedUser.getId());
    ...
    public ResponseEntity<AuthResponse> signIn(@RequestBody LoginRequest loginRequest) {
        ...
        // Get user from database to include ID in JWT
        User user = userRepository.findByEmail(username);
        String jwt = JwtProvider.generateToken(authentication, user);
        logger.info("JWT generated for logged-in user: {} with ID: {}", username, user.getId());
